...
int main(void)
{
    ...
    // LL_GPIO_SetPinSpeed (pin1.GPIOx, pin1.Pin, LL_GPIO_SPEED_FREQ_HIGH);
    led = &pin1;
    ...
    */
    //tim2_ptr = Timer_Callback;
    //TIM_SetupCounterTIM2(220);
    //printf ("%d\n", LL_RCC_GetAPB2Prescaler());

    TIM_SetupCounterTIM1(10000, Timer_Callback);
