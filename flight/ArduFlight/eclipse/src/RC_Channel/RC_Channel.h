...
//		  AP_Param::setup_object_defaults(this, var_info);
    ...
    */
    ...
    int16_t    get_radio_min() const {return _radio_min;}
    void       set_radio_min(int16_t val){_radio_min = val;}

    int16_t    get_radio_max() const {return _radio_max;}
    void       set_radio_max(int16_t val){_radio_max = val;}

    int16_t    get_radio_trim() const { return _radio_trim;}
    void       set_radio_trim(int16_t val) { _radio_trim = (val);}
