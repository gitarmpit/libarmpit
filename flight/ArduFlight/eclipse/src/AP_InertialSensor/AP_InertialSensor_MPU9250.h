...
public:
    ...
    static AP_InertialSensor_Backend *probe(AP_InertialSensor &imu);  //TODO pass dev I2C
    //static AP_InertialSensor_Backend *probe(AP_InertialSensor &imu);  //TODO pass dev SPI probably don't need
...
private:
    ...
    //AP_HAL::OwnPtr<AP_HAL::Device> _dev;  //TODO dev is I2C or SPI
