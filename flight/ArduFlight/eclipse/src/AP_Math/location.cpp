...
{
    return (uint32_t)get_distance(loc1, loc2) * 100;
}
...
int32_t get_bearing_cd(const struct Location &loc1, const struct Location &loc2)
{
    ...
    int32_t off_y = (int32_t)(((float)loc2.lat - (float)loc1.lat) / longitude_scale(loc2));
    int32_t bearing = 9000 + (int32_t)(atan2f((float)-off_y, (float)off_x) * 5729.57795f);
