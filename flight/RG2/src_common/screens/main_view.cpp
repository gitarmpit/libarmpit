...
void MainView::Run()
{
    ...
    while (!_done)
    {
        ...
        _lcd->drawBmp2(7, 23, settings_36x36_16);
        _lcd->drawBmp2(47, 23, crosshair_36x36_16);
        _lcd->drawBmp2(87, 23, battery_36x36_16);

        _lcd->drawBmp2(7, 71, jb_36x36_16);
        _lcd->drawBmp2(47, 71, compass_36x36_16);
        _lcd->drawBmp2(90, 76, log_icon_30x30_16);
        _lcd->display();
        ...
        _lcd->printf (2, 0, "%02d:%02d:%02d %d/%d/20%d", hour, min, sec, month, day, year);
