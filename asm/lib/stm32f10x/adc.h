...
#define ADC1_SR    ADC1_BASE
#define ADC2_SR    ADC2_BASE
#define ADC3_SR    ADC3_BASE
#define ADC1_CR1   ADC1_BASE + 0x4
#define ADC2_CR1   ADC2_BASE + 0x4
#define ADC3_CR1   ADC3_BASE + 0x4
#define ADC1_CR2   ADC1_BASE + 0x8
#define ADC2_CR2   ADC2_BASE + 0x8
#define ADC3_CR2   ADC3_BASE + 0x8
#define ADC1_SMPR1 ADC1_BASE + 0xc
#define ADC2_SMPR1 ADC2_BASE + 0xc
#define ADC3_SMPR1 ADC3_BASE + 0xc
#define ADC1_SMPR2 ADC1_BASE + 0x10
#define ADC2_SMPR2 ADC2_BASE + 0x10
#define ADC3_SMPR2 ADC3_BASE + 0x10

//high threshold
#define ADC1_HTR  ADC1_BASE + 0x24
#define ADC2_HTR  ADC2_BASE + 0x24
#define ADC3_HTR  ADC3_BASE + 0x24

//low threshold
#define ADC1_LTR  ADC1_BASE + 0x28
#define ADC2_LTR  ADC2_BASE + 0x28
#define ADC3_LTR  ADC3_BASE + 0x28

#define ADC1_SQR1  ADC1_BASE + 0x2c
#define ADC2_SQR1  ADC2_BASE + 0x2c
#define ADC3_SQR1  ADC3_BASE + 0x2c    
#define ADC1_SQR2  ADC1_BASE + 0x30
#define ADC2_SQR2  ADC2_BASE + 0x30
#define ADC3_SQR2  ADC3_BASE + 0x30
#define ADC1_SQR3  ADC1_BASE + 0x34
#define ADC2_SQR3  ADC2_BASE + 0x34
#define ADC3_SQR3  ADC3_BASE + 0x34
#define ADC1_JSQR  ADC1_BASE + 0x38
#define ADC2_JSQR  ADC2_BASE + 0x38
#define ADC3_JSQR  ADC3_BASE + 0x38
...
#define ADC3_JDR1  ADC3_BASE + 0x3c
#define ADC3_JDR2  ADC3_BASE + 0x40
#define ADC3_JDR3  ADC3_BASE + 0x44
#define ADC3_JDR4  ADC3_BASE + 0x48

//data register
#define ADC1_DR  ADC1_BASE + 0x4c
#define ADC2_DR  ADC2_BASE + 0x4c
#define ADC3_DR  ADC3_BASE + 0x4c
