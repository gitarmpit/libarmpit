...
#define PORT_PCR_IRQC_OFF         (0<<19)
#define PORT_PCR_IRQC_DMA_RISING  (1<<19)
#define PORT_PCR_IRQC_DMA_FALLING (2<<19)
#define PORT_PCR_IRQC_DMA_EITHER  (3<<19)
#define PORT_PCR_IRQC_INT_ZERO    (8<<19)
#define PORT_PCR_IRQC_INT_RISING  (9<<19)
#define PORT_PCR_IRQC_INT_FALLING (10<<19)
#define PORT_PCR_IRQC_INT_EITHER  (11<<19)
#define PORT_PCR_IRQC_INTONE      (12<<19)
#define PORT_PCR_IRQC_CLEARMASK   (0xf<<19)
