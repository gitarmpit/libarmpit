...
static BOOL RCC_IsHSIActive(void)
{
    ...
    return ((sws_mask == RCC_CFGR_SWS_HSI) || 
        ((sws_mask == RCC_CFGR_SWS_PLL) && (RCC_CFGR & RCC_CFGR_PLLSRC_HSI_DIV2)));
...
{
    return (RCC_CFGR & RCC_CFGR_SWS_HSE) || 
        ((RCC_CFGR & RCC_CFGR_SWS_PLL) && (RCC_CFGR & RCC_CFGR_PLLSRC_HSE));
}
