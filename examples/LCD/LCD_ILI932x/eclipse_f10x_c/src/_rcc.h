...
#include "common.h"
#define __RCC_ADDR__ *(volatile uint32_t*)
#else
#define __RCC_ADDR__
#endif
...
#define RCC_CR        __RCC_ADDR__(RCC_BASE + 0x00)
#define RCC_CFGR      __RCC_ADDR__(RCC_BASE + 0x04)
#define RCC_APB2RSTR  __RCC_ADDR__(RCC_BASE + 0x0c)
#define RCC_APB1RSTR  __RCC_ADDR__(RCC_BASE + 0x10)
#define RCC_AHBENR    __RCC_ADDR__(RCC_BASE + 0x14)
#define RCC_APB2ENR   __RCC_ADDR__(RCC_BASE + 0x18)
#define RCC_APB1ENR   __RCC_ADDR__(RCC_BASE + 0x1c)
#define RCC_BDCR      __RCC_ADDR__(RCC_BASE + 0x20)
#define RCC_CSR       __RCC_ADDR__(RCC_BASE + 0x24)
#define RCC_CFGR2     __RCC_ADDR__(RCC_BASE + 0x2c)
