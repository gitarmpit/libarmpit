...
#define MOTOR_TIMER            TIM3_PC_6_7_8_9    //TIM3
//#define CONTROLLER_TIMER       TIM2::GetInstance()                      //TIM2
#define PITCH_ROLL_LED_TIMER   TIM1_PA_8_9_10_11        //TIM1
#define THROTTLE_LED_TIMER     TIM4_PD_12_13_14_15      //TIM4
...
#define CONTROLLER_ROLL_PIN            GPIO_PIN1
#define CONTROLLER_PITCH_PIN           GPIO_PIN2
#define CONTROLLER_THROTTLE_PIN        GPIO_PIN3

#define CONTROLLER_ROLL_CHANNEL        2
#define CONTROLLER_PITCH_CHANNEL       3
#define CONTROLLER_THROTTLE_CHANNEL    4
