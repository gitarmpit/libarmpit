...
AP_InertialSensor_Backend *AP_InertialSensor_MPU9250::probe(AP_InertialSensor &imu)  //TODO pass I2c in here
{
    AP_InertialSensor_MPU9250 *sensor =
        new AP_InertialSensor_MPU9250(imu, BUS_TYPE_I2C, 0); //TODO add I2c parameter here
    if (!sensor || !sensor->_init()) {
        delete sensor;
        return nullptr;
    }
    sensor->_id = 0;  //TODO add ID //HAL_INS_MPU9250_I2C;
...
void AP_InertialSensor_MPU9250::start()
{
    ...
    //_dev->set_speed(AP_HAL::Device::SPEED_LOW);  TODO
...
{
    reg |= _read_flag;
    //return _dev->read_registers(reg, buf, size);  TODO I2C read
    return true;
}
...
uint8_t AP_InertialSensor_MPU9250::_register_read(uint8_t reg)
{
    ...
    reg |= _read_flag;
    //_dev->read_registers(reg, &val, 1);  //TODO I2C read
...
{
    //_dev->write_register(reg, val);  //TODO I2C write
}
...
bool AP_InertialSensor_MPU9250::_hardware_init(void)
{
    ...
    //_dev->set_speed(AP_HAL::Device::SPEED_HIGH);  TODO
