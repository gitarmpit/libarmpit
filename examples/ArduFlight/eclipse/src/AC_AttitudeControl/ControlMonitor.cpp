...
{
    const PID_Info &iroll  = get_rate_roll_pid().get_pid_info();
    ...
    const PID_Info &ipitch = get_rate_pitch_pid().get_pid_info();
    ...
    const PID_Info &iyaw   = get_rate_yaw_pid().get_pid_info();
