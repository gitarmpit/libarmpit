...
AP_Baro_BMP085::AP_Baro_BMP085(AP_Baro &baro) //TODO add dev i2c/spi
...
void AP_Baro_BMP085::_cmd_read_pressure()
{
    ...
    _last_press_read_command_time = millis();
}
...
void AP_Baro_BMP085::_cmd_read_temp()
{
    ...
    _last_temp_read_command_time = millis();
}
...
bool AP_Baro_BMP085::_data_ready()
{
    ...
    if (_state == 0) {
        return millis() > _last_temp_read_command_time + 5;
    }
    ...
    return millis() > _last_press_read_command_time + conversion_time_msec;
}
