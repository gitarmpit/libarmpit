...
#define RCC_CFGR_MCO_OFF       (0<<24)
#define RCC_CFGR_MCO_SYSCLK    (4<<24)
#define RCC_CFGR_MCO_HSI       (5<<24)
#define RCC_CFGR_MCO_HSE       (6<<24)
#define RCC_CFGR_MCO_PLL_DIV2  (7<<24)
#define RCC_CFGR_MCO_CLEARMASK (7<<24)
...
void RCC_EnableMCO_SYSCLK(void);
void RCC_EnableMCO_HSI(void);
void RCC_EnableMCO_HSE(void);
void RCC_EnableMCO_PLL_DIV2(void);
#ifdef __cplusplus
}
#endif
