...
public:
    ...
    USART(volatile uint32_t* pUSART_SR, volatile uint32_t* pUSART_DR,
          ...
          IRQn_Type irqNo, bool isUSART1, DMA_CHANNEL dmaRxChannel,
          DMA_CHANNEL dmaTxChannel, volatile uint32_t* enableReg,
          volatile uint32_t* resetReg, uint32_t bit) :
    ...
    enum STOP_BIT
    {
        STOP_1 = USART_CR2_STOP_1, STOP_0_5 = USART_CR2_STOP_0_5, STOP_2 = USART_CR2_STOP_2, STOP_1_5 = USART_CR2_STOP_1_5
    };
...
private:
    USART1() :
            USART(&USART1_SR, &USART1_DR, &USART1_BRR, &USART1_CR1, &USART1_CR2, &USART1_CR3, IRQn_USART1, true, DMA_CHANNEL_5,
                    DMA_CHANNEL_4, &RCC_APB2ENR, &RCC_APB2RSTR, RCC_APB2ENR_USART1EN)
    {
    }
...
private:
    USART2() :
            USART(&USART2_SR, &USART2_DR, &USART2_BRR, &USART2_CR1, &USART2_CR2, &USART2_CR3, IRQn_USART2, false, DMA_CHANNEL_6,
                    DMA_CHANNEL_7, &RCC_APB1ENR, &RCC_APB1RSTR, RCC_APB1ENR_USART2EN)
    {
    }
...
private:
    USART3() :
            USART(&USART3_SR, &USART3_DR, &USART3_BRR, &USART3_CR1, &USART3_CR2, &USART3_CR3, IRQn_USART3, false, DMA_CHANNEL_3,
                    DMA_CHANNEL_2, &RCC_APB1ENR, &RCC_APB1RSTR, RCC_APB1ENR_USART3EN)
    {
    }
