...

{
    ...
    for (uint8_t i = 0; i < 8; ++i)
    {
        ...
        _dmaStreams[i]._pDMA_SFCR  = (uint32_t*) ((uint32_t)pDMAx_SFCR  + (i * 0x18));
...
void DMA_Stream::EnableFIFO()
{
    *_pDMA_SFCR |= (DMA_SFCR_DMDIS | DMA_SFCR_FS_FULL) ;
}
