...
/// from http://www.airspayce.com/mikem/arduino/RF22/RF22-1.27.zip
...
public:
    ...
    RF22(SPI* spi, GPIO_PIN* ssPin, GPIO_PIN* sdnPin, GPIO_PIN* InterruptPin);
...
private:
    SPI* _spi;
    GPIO_PIN *_sdnPin, *_intPin, *_ssPin;
