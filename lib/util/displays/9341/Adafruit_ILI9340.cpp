...
Adafruit_ILI9340::Adafruit_ILI9340(SPI* spi, GPIO_PIN* dcPin, GPIO_PIN* rstPin, GPIO_PIN* ssPin)
...
void Adafruit_ILI9340::writecommand(uint8_t cmd)
{
    _dcPin->Reset();
    _ssPin->Reset();
...
void Adafruit_ILI9340::writedata(uint8_t data)
{
    _dcPin->Set();
    _ssPin->Reset();
