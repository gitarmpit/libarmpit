...
#define	BLACK   		0x0000
#define WHITE   		0xFFFF
#define RED COLOR565(31,0,0)
#define GREEN COLOR565(0,63,0)
#define BLUE COLOR565(0,0,31)
#define YELLOW COLOR565(31,63,0)
#define CYAN   COLOR565(0,63,31)
...
public:
    ...
    void drawBmp2(int16_t x, int16_t y, const uint8_t *bmp);
