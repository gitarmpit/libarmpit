...
Adafruit_SSD1306::Adafruit_SSD1306(I2C* i2c) :
...
void Adafruit_SSD1306::ssd1306_command(uint8_t cmd)
{
    //_dcPin->Reset();
    //_spi->TransmitByte(c);
    _i2c->MasterWrite(0x3c, 0x0, cmd);
}

void Adafruit_SSD1306::ssd1306_data(uint8_t data)
{
    //_dcPin->Set();
    //_spi->TransmitByte(data);
    _i2c->MasterWrite(0x3c, 0x40, data);
}
...
void Adafruit_SSD1306::display(void)
{
    ...
    _i2c->MasterWrite(0x3c, 0x40, SSD1306_LCDWIDTH * SSD1306_LCDHEIGHT / 8, buffer);

//    for (uint16_t i = 0; i < (SSD1306_LCDWIDTH * SSD1306_LCDHEIGHT / 8); i++)
//    {
//        //try the 0x40 + the whole buffer
