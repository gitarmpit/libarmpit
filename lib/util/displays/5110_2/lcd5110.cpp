...
LCD5110::LCD5110(SPI* spi, GPIO_PIN* dcPin, GPIO_PIN* rstPin, GPIO_PIN* ssPin, bool reverse)
{
	_spi = spi;
	_dcPin = dcPin;
	_rstPin = rstPin;
...
void LCD5110::Init(uint8_t contrast, uint8_t bias)
{
	...
	SendCommand(contrast); //Set LCD Vop (Contrast): Try 0xB1(good @ 3.3V) or 0xBF if your display is too dark
