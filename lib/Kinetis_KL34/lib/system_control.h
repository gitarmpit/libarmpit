...
#define  SCB_CPUID_PARTNO_S        4
#define  SCB_CPUID_PARTNO_E       15
#define  SCB_CPUID_ARCHITECTURE_S 16
#define  SCB_CPUID_ARCHITECTURE_E 19
#define  SCB_CPUID_VARIANT_S      20
#define  SCB_CPUID_VARIANT_E      23
#define  SCB_CPUID_IMPLEMENTER_S  24
#define  SCB_CPUID_IMPLEMENTER_E  31
...
void SCB_EnableUnalignedTrap(void);
void SCB_EnableMemoryFault(void);
