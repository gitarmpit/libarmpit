...
class TIMER_Channel
{
    ...
    friend class TIMER_With_SlaveMode;
...
public:
    ...
    void SetOCCPolarityLow(bool set);
    void SetICCRisingEdge();
    void SetICCFallingEdge();
#ifdef STM32F4
    void SetICCBothEdges();
#endif
    ...
    void UpdatePWM(uint32_t period, uint32_t duty_us);
...
public:
    ...
    static TIMER* Get_Instance(TIMER_Number timer_no);
    ...
    void SetUpdatePeriod_ns (uint32_t ns);

    uint32_t GetCounterValue();
    uint32_t GetPrescalerValue();
    uint32_t GetAutoReloadValue();
    ...
    void CalculateTimerValues_ns (uint32_t ns, uint32_t* count, uint16_t* presc);
    ...
    void SetInterruptHandler (TIMER_Interrupt_Handler* handler);
    virtual void HandleInterrupt();

    uint32_t GetTimerClockFreq();

#if defined(STM32F2) || defined(STM32F4)
    GPIO_AF GetAf() { return _af; }
#endif
...
class TIMER_With_SlaveMode : public TIMER_With_Channels
{
private:
...
public:
    TIMER_With_SlaveMode(uint32_t timx_base_addr, uint8_t nchannels, IRQn_Type irqNo,
            volatile uint32_t* rccEnableReg,  volatile uint32_t* rccResetReg, uint32_t rccBit, bool isAPB1);
    //smcr
    ...
    void CaptureInputPWM (uint32_t max_period_us, PWM_Capture_Handler* handler);
...
class AdvancedTimer: public TIMER_With_SlaveMode,
...
class TIM2: public TIMER_With_SlaveMode,
public TIMER_With_DMAControl,
public TIMER_With_OnePulseMode,
public TIMER_With_UpDownCounter,
public TIMER_With_MMS
...
private:
    TIM2() :
    TIMER_With_SlaveMode(TIM2_BASE, 4, IRQn_TIM2, &RCC_APB1ENR, &RCC_APB1RSTR, RCC_APB1ENR_TIM2EN, true),
...
class TIM3: public TIMER_With_SlaveMode,
public TIMER_With_DMAControl,
public TIMER_With_OnePulseMode,
public TIMER_With_UpDownCounter,
public TIMER_With_MMS
...
private:
    TIM3() :
    TIMER_With_SlaveMode(TIM3_BASE, 4, IRQn_TIM3, &RCC_APB1ENR, &RCC_APB1RSTR, RCC_APB1ENR_TIM3EN, true),
...
class TIM4: public TIMER_With_SlaveMode,
public TIMER_With_DMAControl,
public TIMER_With_OnePulseMode,
public TIMER_With_UpDownCounter,
public TIMER_With_MMS
...
private:
    TIM4() :
    TIMER_With_SlaveMode(TIM4_BASE, 4, IRQn_TIM4, &RCC_APB1ENR, &RCC_APB1RSTR, RCC_APB1ENR_TIM4EN, true),
...
class TIM5: public TIMER_With_SlaveMode,
public TIMER_With_DMAControl,
public TIMER_With_OnePulseMode,
public TIMER_With_UpDownCounter,
public TIMER_With_MMS
...
private:
    TIM5() :
    TIMER_With_SlaveMode(TIM5_BASE, 4, IRQn_TIM5, &RCC_APB1ENR, &RCC_APB1RSTR, RCC_APB1ENR_TIM5EN, true),
...
class TIM6: public TIMER, public TIMER_With_MMS
{
private:
    TIM6() :
...
class TIM7: public TIMER, public TIMER_With_MMS
{
private:
    TIM7() :
...
class TIM9 : public TIMER_With_SlaveMode,
public TIMER_With_OnePulseMode
{
private:
    TIM9() :
    TIMER_With_SlaveMode(TIM9_BASE, 2, IRQn_TIM1_BRK_TIM9, &RCC_APB2ENR, &RCC_APB2RSTR, RCC_APB2ENR_TIM9EN, false),
